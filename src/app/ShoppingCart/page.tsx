...
function ShoppingCart() {
  ...
  return (
    <div className="bg-white px-2 w-[500px] h-[700px] ml-[1040px] ">
      <h2 className="text-3xl font-bold mb-4 text-black hover:scale-y-150 hover:text-red-500">Shopping Cart</h2>
      ...
      <div className=" flex flex-col mt-[50px] ">
        ...
        <div className="flex justify-center mt-4 gap-4">
          <button className="text-xs text-black px-6 rounded-2xl border-2 border-gray-300 hover:scale-125  hover:bg-blue-300">
            View Cart
          </button>
          <button
            className="text-xs text-black px-6 rounded-2xl py-1 border-2 border-gray-300 hover:scale-125  hover:bg-blue-300"
